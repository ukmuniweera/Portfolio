...
export const ABOUT = {
  intro:
    "Versatile and results driven Full Stack Developer with hands on experience in designing, developing and deploying scalable web applications. Skilled in modern frontend and backend technologies, RESTful API design and database management. Strong problem solving abilities with a collaborative mindset, eager to deliver secure, efficient and user focused software solutions.",
  stats: [
    { label: "University of Vavuniya", value: "B.Sc. in Information Technology" },
    { label: "Dharmaraja College", value: "Engineering Technology" },
...
export const LINKS = [
  {
    label: "GitHub",
    href: "https://github.com/ukmuniweera",
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/udula-kesara-muniweera",
    icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "Email",
    href: "mailto:ukmuniweera@gmail.com",
    icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      <path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-.904.732-1.636 1.636-1.636h.025l10.339 7.646 10.339-7.646h.025c.904 0 1.636.732 1.636 1.636z"/>
    </svg>`
  }
];
